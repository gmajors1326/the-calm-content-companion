        ...
        const rawTier = params.get('tier') || params.get('plan') || 'Free';
        ...
        else if (rawTier.toLowerCase().includes('free')) initialTier = 'Free';
        // Fallback for Wix internal names
        else if (rawTier.toLowerCase().includes('premium') || rawTier.toLowerCase().includes('gold')) initialTier = 'Pro';
        else if (rawTier.toLowerCase().includes('vip') || rawTier.toLowerCase().includes('diamond')) initialTier = 'Elite';
        ...
        window.addEventListener('message', (event) => {
            ...
            if (event.data.type === 'USER_DATA' || event.data.type === 'SYNC_PLAN') {
                ...
                if (incomingTier.includes('elite') || incomingTier.includes('vip') || incomingTier.includes('diamond')) detectedTier = 'Elite';
                else if (incomingTier.includes('pro') || incomingTier.includes('premium') || incomingTier.includes('gold')) detectedTier = 'Pro';
